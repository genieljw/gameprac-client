...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////playingscene.js velocity 추가 코드////////////////////
...
export default class PlayingScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.input.on('pointerdown', (pointer)=>{
      ...
      beam.isLocal = true; //로컬에서 형성된 빔(발사체 출처 구분)
      ...
      callback: () => {
        if (this.m_player) {
          this.socket.emit('playerMove', {
            x: this.m_player.x,
            y: this.m_player.y,
            xVelocity: this.m_player.body.velocity.x,
            yVelocity: this.m_player.body.velocity.y,
          });
        }
      },
      callbackScope: this,
  ...
  setupSocketListeners() {
    this.socket.on('state', (state) => {
      Object.keys(state).forEach((playerId) => {
        ...
        const { x, y, xvelocity, yvelocity } = playerData;
